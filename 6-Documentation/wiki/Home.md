...
| `wiki/Text-to-CAD-Environment.md` | Text-to-CAD environment — venv bootstrap, `build123d` / `OCP` verification, agent contract |
...
| `wiki/Text-to-CAD-Environment.md` | VSCode tasks and npm scripts that create `5-Applications/text-to-cad/.venv` and verify `build123d` / `OCP` |
